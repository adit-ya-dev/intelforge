// app/onboarding/components/ChecklistPanel.tsx
  ...
  return (
    <div className="bg-white dark:bg-black rounded-xl border border-zinc-200 dark:border-zinc-800 p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-black dark:text-white">Getting Started Checklist</h3>
              ...
              <div className="flex items-start gap-3">
                <button
                  ...
                  className={`mt-0.5 flex-shrink-0 ${
                    item.completed ? 'text-blue-600' : 'text-zinc-400'
                  }`}
                >
                  {item.completed ? (
                ...
                <div className="flex-1">
                  <p className={`text-sm font-medium ${
                    item.completed ? 'text-zinc-500 dark:text-zinc-500 line-through' : 'text-black dark:text-white'
                  }`}>
                    {item.label}
                  </p>
                ...
                {item.action && !item.completed && (
                  <button
                    className="px-3 py-1 text-xs bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-900/50 rounded hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                  >
                    Start
                  </button>
                )}
      ...
      {checklist.progress === 100 && (
        <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-900/30 rounded-lg">
