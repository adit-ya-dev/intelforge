// app/onboarding/components/WatchlistBuilder.tsx
...
export default function WatchlistBuilder() {
  ...
  // Simplified: All icons share the same monochrome look, no colored backgrounds
      ...
      <div className="bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-lg p-4">
        ...
        <div className="flex gap-2">
          ...
          <select
            ...
            className="px-3 py-2 bg-white dark:bg-black border border-zinc-300 dark:border-zinc-700 rounded text-black dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-600"
          >
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {suggestions.filter(s => !watchlist.find(w => w.id === s.id)).map((suggestion) => (
            <div
              key={suggestion.id}
              className="bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-lg p-4 hover:border-blue-600 transition-colors"
            >
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  className="p-1 text-blue-600 dark:text-blue-400 hover:text-blue-800 transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
