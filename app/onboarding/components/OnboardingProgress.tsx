// app/onboarding/components/OnboardingProgress.tsx
          ...
          >
            ...
            <div className="flex-1">
              <p className={`text-sm font-medium ${
                step.completed ? 'text-black dark:text-white' : 'text-zinc-900 dark:text-zinc-100'
              }`}>
                {step.title}
              </p>
              ...
              {step.required && !step.completed && (
                <span className="inline-block px-2 py-0.5 mt-2 text-xs bg-black text-white dark:bg-white dark:text-black rounded-full">
                  Required
                </span>
              )}
            </div>
