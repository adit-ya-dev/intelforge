// app/onboarding/components/RecommendedActions.tsx
    ...
    <div className="bg-white dark:bg-black rounded-xl border border-zinc-200 dark:border-zinc-800 p-6">
      ...
      <div className="space-y-4">
        {actions.map((action, index) => (
          <div
            key={index}
            className="bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-lg p-4 hover:border-blue-600 dark:hover:border-blue-500 transition-colors"
          >
